...
<body>
	...
	<span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776;</span>
        <div style="width:400px; margin:50px auto; border:solid #03021c 1px">
                <h4 align="center">Update Stock Quantity</h4>
                <form action="#" method="post" style="padding:20px 50px" label="Log In">
                        ...
                        <input type="number" name="add_quan" required>
                        <br />
                        <br />
                        <button type="submit">Add Stock Quantity</button>
                        <br />
        ...
        <?php
                if($_SERVER["REQUEST_METHOD"] == "POST"){
                        ...
                        if(is_array($row)) {
                                $quan = $row['stock_quan'];
                                $newquan = $quan + $_POST['add_quan'];
                                $sqlup = "UPDATE stock SET stock_quan='".$newquan."' WHERE stock_id='" . $_POST["stock_id"] . "'";
