	...
	<span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776;</span>
        ...
        <?php
                if($_SERVER["REQUEST_METHOD"] == "POST"){
                        ...
                        $sql = "SELECT * FROM customer WHERE cust_email='" . $_POST["cust_email"] . "'";
                        ...
                        if(is_array($row)) {
                                ...
                                <p align='left'><b>Customer Name:</b> {$row["cust_name"]}</p>
                                <p align='left'><b>Cust Id: </b>{$row["cust_id"]}</p >
                                <p align='left'><b>Customer email: </b>{$row["cust_email"]}</p >
                                <p align='left'><b>Customer Phone: </b>{$row["cust_phone"]}</p >
                                <p align='left'><b>Customer balance: </b>{$row["cust_balance"]}</p>
                                <hr />
                                </div>";
                        } else {
                                        echo "<h4 align='center'>Customer Not Found!<h4>";
                        }
                }
        ?>
</body>
