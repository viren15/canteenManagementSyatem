...
<body>
	...
	<span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776;</span>
        <div style="width:400px; margin:50px auto; border:solid #03021c 1px">
                <h4 align="center">Update Balance</h4>
                <form action="#" method="post" style="padding:20px 50px" label="Log In">
                        ...
                        <input type="number" name="add_bal" required>
                        <br />
                        <br />
        ...
        <?php
                if($_SERVER["REQUEST_METHOD"] == "POST"){
                        ...
                        if(is_array($row)) {
                                $bal = $row['cust_balance'];
                                $newbal = $bal + $_POST['add_bal'];
                                $sqlup = "UPDATE customer SET cust_balance='".$newbal."' WHERE cust_email='" . $_POST["cust_email"] . "'";
